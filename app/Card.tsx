...
export default function Card({
  ...
  return (
    <div style={frameStyle}>
      ...
      <div style={{ ...artStyle, cursor: onArtClick ? "pointer" : "default", overflow: "hidden" }} onClick={onArtClick}>
        {card.imageUrl
          ? <img src={card.imageUrl} alt="card art" style={{ width: "100%", height: "100%", objectFit: "cover", display: "block" }} />
